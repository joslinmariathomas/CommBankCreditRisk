...
CREDIT_BUREAU_COLS_LIST = ['AMT_REQ_CREDIT_BUREAU_HOUR', 'AMT_REQ_CREDIT_BUREAU_DAY',
                     'AMT_REQ_CREDIT_BUREAU_WEEK', 'AMT_REQ_CREDIT_BUREAU_MON',
                     'AMT_REQ_CREDIT_BUREAU_QRT', 'AMT_REQ_CREDIT_BUREAU_YEAR']
SOCIAL_CIRCLE_COLS_LIST = ['OBS_30_CNT_SOCIAL_CIRCLE', 'DEF_30_CNT_SOCIAL_CIRCLE',
...
class ImputationConfig:
    ...
    FEATURES_TO_IMPUTE_ZERO_WHEN_MISSING = CREDIT_BUREAU_COLS_LIST + SOCIAL_CIRCLE_COLS_LIST
...
'EXT_SOURCE_3':"mean_across_features",
    ...
    GROUPING_COLUMNS = {'YEARS_EMPLOYED_IMPUTED':['NAME_EDUCATION_TYPE', 'CODE_GENDER'],
